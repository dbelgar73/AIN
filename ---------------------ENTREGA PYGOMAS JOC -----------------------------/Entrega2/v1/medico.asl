+flag(F): team(200)
  ...
  .get_service("[MEDICO]: comandante");  // Busca al agente comandante
...
+target_reached(T): team(200)
  ...
  .print("[MEDICO]: En posición! :D ").  // Muestra un mensaje indicando que el agente está en su posición  
...
+comandante(C)
  ...
  .print("[MEDICO]: A sus ordenes comandante! o.o ").  // Muestra un mensaje indicando que se ha encontrado al comandante  
...
// Crea paquetes cada 4 segundos comandante
+crearPaquetes
  <-
...
+venAlCentro:posicionBandera(F)
  ...
  .print("[MEDICO]: Entendido");  // Mostrar un mensaje indicando que ha entendido la orden
